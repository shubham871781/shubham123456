...
export default function DoctorRegistration() {
  ...
  const formik = useFormik({
    ...
    onSubmit: values => {
      ...
      bodyFormData.append('experience_years', values.experience_years);
      bodyFormData.append('user_id', values.user_id);
      //     bodyFormData.append('profile_photo', values.profile_photo.slice(27));
      // console.log(values.profile_photo.slice(0,21))
      // console.log(values.profile_photo.slice(27))
                ...
                <div className='bg-white rounded10 shadow-lg'>
                  ...
                  <div className='p-40'>
                    <form onSubmit={formik.handleSubmit}>
                      ...
                      <div className='form-group'>
                        <div className='input-group mb-3'>
                          ...
                          <input
                            ...
                            type='text'
                            name='clinic_registration_number'
                            {...formik.getFieldProps('clinic_registration_number')}
                      ...
                      <input type='file' name='profile_photo' {...formik.getFieldProps('profile_photo')} />
                      <input type='file' id='digital_signature' name='digital_signature' {...formik.getFieldProps('digital_signature')} />
                      <label htmlFor='img'>Select image:</label>
                      <input type='file' id='address_proof_of_clinic_regetration' {...formik.getFieldProps('address_proof_of_clinic_regetration')} name='address_proof_of_clinic_regetration' />
                      <label htmlFor='img'>Select image:</label>
                      <input type='file' id='degree_certificate' name='degree_certificate' {...formik.getFieldProps('degree_certificate')} />
                      <label htmlFor='img'>Select image:</label>
                      <input type='file' id='doctor_regestration_no_proof' {...formik.getFieldProps('doctor_regestration_no_proof')} name='doctor_regestration_no_proof' />




                      <label htmlFor='img'>Select image:</label>
                      <input type='file' id='clinic_regestration_certificate' name='clinic_regestration_certificate'
                        {...formik.getFieldProps('clinic_regestration_certificate')}
                        accept='image/*' />
                      <div className='col-12 text-center'>
                        <button
                          type='submit'
